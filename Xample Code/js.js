var _createClass = function () {function defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function (Constructor, protoProps, staticProps) {if (protoProps) defineProperties(Constructor.prototype, protoProps);if (staticProps) defineProperties(Constructor, staticProps);return Constructor;};}();function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}var Game = function () {
    ...
    function Game() {_classCallCheck(this, Game);
        this.score = 0;
    ...
    /**
       ...
       */_createClass(Game, [{ key: "calculateScale", value: function calculateScale()
        {
        ...
        /**
           ...
           */ }, { key: "generateSticks", value: function generateSticks()
        {
            var numberOfSticks = Math.ceil(this.steps);
            for (var i = 0; i <= numberOfSticks; i++) {if (window.CP.shouldStopExecution(0)) break;
                new Stick();}window.CP.exitedLoop(0);
        } }, { key: "generateBall", value: function generateBall()

        {
            this.balltween = new TimelineMax({ repeat: -1, paused: 1 });
            $('.scene .ball-holder').append('<div class="ball red" id="ball"></div>');
            this.bounce();
        } }, { key: "generateTweet", value: function generateTweet()
        ...
        /**
           ...
           */ }, { key: "intro", value: function intro()
        {var _this = this;
            ...
            to('.start-game .section-1 .ball-demo', 0.5, { y: "0px", scaleY: 1, transformOrigin: "bottom", ease: Power2.easeOut,
                onStart: function onStart() {
                    while (_this.prevColor == _this.color) {if (window.CP.shouldStopExecution(1)) break;
        ...
        /**
          * Display score
           */ }, { key: "showResult", value: function showResult()
        {
        ...
        /**
           ...
           * @param  {int} score
           * @return {string} grade
           */ }, { key: "showGrade", value: function showGrade(
        score) {
...

        {
            ...
            this.showResult();
        } }, { key: "scaleScreen", value: function scaleScreen()
        ...
        /**
           ...
           */ }, { key: "scaleScreenAndRun", value: function scaleScreenAndRun()
        {
        ...
        /**
           ...
           */ }, { key: "moveToStart", value: function moveToStart()
        {var _this2 = this;
        ...
        /**
           ...
           */ }, { key: "moveScene", value: function moveScene()
        {var _this3 = this;

            this.timeline.add(
            TweenMax.to('#sticks', this.time, { x: '-=180px', ease: Power0.easeNone, repeat: -1, onRepeat: function onRepeat() {_this3.rearrange();} }));
        ...
        /**
           ...
           */ }, { key: "rearrange", value: function rearrange()
        {
        ...
        /**
           ...
           */ }, { key: "speedUp", value: function speedUp()
        {
            if (this.score > 30) {
                return 1.8;
            }
        ...
        {var _this4 = this;
            ...
            to('#ball', this.time / 2, { y: '-=250px', scaleY: 1.1, transformOrigin: "bottom", ease: Power2.easeOut,
                onStart: function onStart() {
                    while (_this4.prevColor == _this4.color) {if (window.CP.shouldStopExecution(2)) break;
                    ...
                    removeClass('yellow').
                    removeClass('purple').
                    addClass(new Color().colorcodeToName(_this4.color));
                } });

        } }, { key: "checkColor", value: function checkColor()
...
Stick = function () {
    ...
    function Stick() {_classCallCheck(this, Stick);
        this.stick = this.addStick();
    }_createClass(Stick, [{ key: "addStick", value: function addStick()
...
Color = function () {
    ...
    function Color() {_classCallCheck(this, Color);
        this.colors = ["#FF4571", "#FFD145", "#8260F6"];
        this.effects = ["bubble", "triangle", "block"];
        this.prevEffect = null;
    }_createClass(Color, [{ key: "getRandomColor", value: function getRandomColor()

        {
            var colorIndex = Math.random() * 3;
            var color = this.colors[Math.floor(colorIndex)];
            return color;
        } }, { key: "colorcodeToName", value: function colorcodeToName(
        ...
        /**
           ...
           */ }, { key: "changeColor", value: function changeColor(
        el) {
        ...
        } }, { key: "getRandomEffect", value: function getRandomEffect()

        {
            var effectIndex = null;

            effectIndex = Math.floor(Math.random() * 3);
            while (effectIndex == this.prevEffect) {if (window.CP.shouldStopExecution(4)) break;
                effectIndex = Math.floor(Math.random() * 3);
        ...
        /**
           ...
           */ }, { key: "setEffect", value: function setEffect(
        el) {
            var effect = this.getRandomEffect();
            el.addClass(effect + '-stick');
            for (var i = 1; i <= 14; i++) {if (window.CP.shouldStopExecution(5)) break;
                if (effect == 'block') {
        ...
        /**
           ...
           */ }], [{ key: "getColorFromClass", value: function getColorFromClass(
        el) {
            var classes = $(el).attr('class').split(/\s+/);
            for (var i = 0, len = classes.length; i < len; i++) {if (window.CP.shouldStopExecution(6)) break;
...
Animation = function () {function Animation() {_classCallCheck(this, Animation);}_createClass(Animation, [{ key: "playBubble",
        ...
        } }, { key: "playTriangle", value: function playTriangle(
        ...
        el) {
            ...
            staggerTo(el.find('.triangle'), 1.5, {
                ...
                repeatDelay: 0.1 },
            0.1);
        } }, { key: "playBlock", value: function playBlock(
        ...
        el) {
            ...
            0.1);
                                             ...
                                             */value: function generateSmallGlows(number) {var h = $(window).height();var w = $(window).width();var scale = w > h ? h / 800 : w / 1200;h = h / scale;w = w / scale;for (var i = 0; i < number; i++) {if (window.CP.shouldStopExecution(7)) break;var left = Math.floor(Math.random() * w);var top = Math.floor(Math.random() * (h / 2));var size = Math.floor(Math.random() * 8) + 4;$('.small-glows').prepend('<div class="small-glow"></div>');var noise = $('.small-glows .small-glow').first();noise.css({ left: left, top: top, height: size, width: size });}window.CP.exitedLoop(7);} }, { key: "sceneAnimation", value: function sceneAnimation() {
